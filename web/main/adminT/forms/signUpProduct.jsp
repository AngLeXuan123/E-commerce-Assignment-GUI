        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="p-5">
                    ...
                    <form method="post" action="http://localhost:8080/E-commerce-Assignment-GUI/signUpProduct" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            <input type="number" step="1" class="form-control" name="quantity" id="quantity" placeholder="Stock left" required>
                        </div>
                        <div class="form-group">
