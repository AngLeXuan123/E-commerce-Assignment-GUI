                    ...
                    <div class="container-fluid">
                        ...
                        <div class="content"><br>
                            <table class="table table-striped table-bordered">
                                ...
                                %>
                                <tr><td><img width="50" height="50" src="data:image/jpg;base64,<%= base64Image %>"><%= rs.getString("id") %></td>
                                <td><a class="btn btn-outline-dark mt-auto" href="staffProfile.jsp?id=<%= rs.getString("id") %>">View staff</a></td>
