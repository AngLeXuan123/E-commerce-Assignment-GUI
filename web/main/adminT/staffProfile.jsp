                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="content">
                            ...
                            <tr><td>Username : </td><td><%= rs.getString("id") %> </td></tr>
                            ...
                            <tr><td><a href="forms/editStaff.jsp?id=<%= id %>"><button type=\"button\">Edit Profile</button></a>
                                <a href="http://localhost:8080/E-commerce-Assignment-GUI/deleteStaff?id=<%= rs.getString("id") %>"><button type=\"button\">Delete profile</button></a></td></tr>
                            </table>
